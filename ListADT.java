 ...
 * Purpose: This interface is an Abstract Data Type for the List type. 
 * The interface would guide a user on how a ListADT object will be created with methods, exceptions and return types. 
 * A List is an ordered sequence of elements that allows elements to be accessed, inserted, 
 * and removed based on their order in the sequence.
 * Creation of Object: A ListADT object represents an empty ordered sequence of elements of a specified type. 
 * Immediately after construction, the list contains no elements (a size of zero), 
 * while remaining in a valid state for future insertions.
 * 
 */
interface ListADT<T> { 
